...
export const metadata: Metadata = {
  title: "Privacy Policy — Redprint",
  description: "How Redprint collects, uses, and protects your information.",
};
  ...
  return (
    <LegalPage title="Privacy Policy" lastUpdated="June 5, 2026">
      ...
      <ul>
        ...
        <li>
          <strong>Application</strong> refers to Redprint, the software program
          provided by the Company.
        </li>
        <li>
          <strong>Company</strong> (referred to as either &quot;the
          Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in
          this Agreement) refers to Redprint, Inc., 1576 Sweet Home Rd, Suite
          209 #7, Buffalo, NY 14228.
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          ...
          forgotten&quot;): You can request that We delete Your Personal Data,
          subject to certain legal exceptions.
        </li>
        <li>
          <strong>Right to restriction of processing</strong>: You can request
          that We limit how We process Your Personal Data in certain
          circumstances.
        </li>
        <li>
        ...
        <li>
          ...
          as the legal basis for processing, You can withdraw that consent at
          any time.
        </li>
        <li>
          <strong>Right to lodge a complaint</strong>: You have the right to
          lodge a complaint with a supervisory authority in the country where
          You reside, work, or where the alleged infringement occurred.
        </li>
      </ul>
      <p>
        <strong>Legal basis for processing.</strong> We process Personal Data
        under one or more of the following legal bases: Your consent,
        performance of a contract with You, compliance with a legal obligation,
        or Our legitimate interests (such as improving and securing the
        Service) provided those interests are not overridden by Your rights.
      </p>
      <p>
        <strong>International transfers.</strong> Personal Data of EEA, UK, or
        Swiss residents may be transferred to and processed in the United
        States. Where required, We rely on appropriate safeguards such as
      ...
      <ul>
        <li>
          <strong>Right to know</strong>: You can request that We disclose the
          categories of Personal Information We have collected, the sources
          from which it was collected, the business purposes for collecting it,
        ...
        <li>
          <strong>Right to correct</strong>: You can request that We correct
        ...
        <li>
          ...
          : We do not use sensitive personal information beyond purposes
      ...
      <p>
        <strong>Categories of Personal Information We collect.</strong> In the
        preceding 12 months, We have collected the following categories of
        Personal Information defined by the CCPA: identifiers (e.g. name,
        email, IP address, device identifiers); customer records (e.g. name,
        contact details); commercial information (e.g. records of
        transactions); internet or other electronic network activity (e.g.
        browsing behavior, interaction with the Application); geolocation data
        (with Your permission); audio, electronic, visual or similar
        information (e.g. photos and videos You upload); and inferences drawn
        from the foregoing.
      </p>
      <p>
        <strong>How to exercise Your CCPA rights.</strong> Submit a request by
        emailing{" "}
        <a href="mailto:info@redprintfit.com">info@redprintfit.com</a>. We will
        verify Your identity before responding. You may also designate an
        authorized agent to act on Your behalf. We will respond within 45 days,
        with a possible 45-day extension if needed.
      </p>
